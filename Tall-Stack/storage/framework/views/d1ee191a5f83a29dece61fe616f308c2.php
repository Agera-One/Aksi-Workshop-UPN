<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('posts.create')); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
            Tambah Post Baru
        </a>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal">
            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?php echo e($post->id); ?></td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?php echo e($post->title); ?></td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?php echo e(Str::limit($post->content, 50)); ?></td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <a href="<?php echo e(route('posts.edit', $post->id)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                        <button wire:click="confirmDelete(<?php echo e($post->id); ?>)" class="text-red-600 hover:text-red-900">Delete</button>
                    </td>
                </tr>
    ...
    <!--[if BLOCK]><![endif]--><?php if($confirmingPostDeletion): ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\laragon\www\workshop-tall\resources\views/livewire/post-list.blade.php ENDPATH**/ ?>